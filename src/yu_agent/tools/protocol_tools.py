...
class MCPTool(Tool):
    ...
    def _discover_tools(self):
        """发现MCP服务器提供的所有工具"""
        try:
            from yu_agent.protocols.mcp.client import MCPClient
            import asyncio
...
class A2ATool(Tool):
    ...
    def run(self, parameters: Dict[str, Any]) -> str:
        ...
        """
        try:
            from yu_agent.protocols.a2a.implementation import A2AClient, A2A_AVAILABLE
...
class ANPTool(Tool):
    ...
    def __init__(self, name: str = "anp", description: str = None, discovery=None, network=None):
        ...
        from yu_agent.protocols.anp.implementation import ANPDiscovery, ANPNetwork
    ...
    def run(self, parameters: Dict[str, Any]) -> str:
        ...
        Returns:
            操作结果
        """
        from yu_agent.protocols.anp.implementation import ServiceInfo
